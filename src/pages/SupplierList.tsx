...
const SupplierListPage = () => {
  const { suppliers, addSupplier, updateSupplier, deleteSupplier } = useData(); // Use data and actions from context
  ...
  const saveSupplier = () => {
    ...
    if (currentSupplier) {
      ...
      updateSupplier({ ...currentSupplier, ...formState }); // Use updateSupplier from context
      toast({
        title: "Berhasil",
      ...
      // Add new supplier
      addSupplier(formState); // Use addSupplier from context
      toast({
        title: "Berhasil",
  ...
  // Delete supplier
  const handleDeleteSupplier = (id: string) => { // Renamed to avoid conflict
    deleteSupplier(id); // Use deleteSupplier from context
    toast({
      title: "Berhasil",
