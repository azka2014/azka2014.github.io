    ...
    <div className="p-4">
        ...
        <Table>
          ...
          <TableBody>
            {incomingTransactions.length === 0 ? (
              <TableRow>
                {/* Updated colspan */}
                <TableCell colSpan={5} className="text-center">Belum ada data barang masuk.</TableCell>
              </TableRow>
            ) : (
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            {/* Dynamic title */}
            <DialogTitle>{currentTransaction ? 'Edit Transaksi Barang Masuk' : 'Tambah Barang Masuk'}</DialogTitle>
            {/* Dynamic description */}
            <DialogDescription>
              {currentTransaction ? 'Edit data transaksi barang masuk.' : 'Tambahkan transaksi barang masuk baru.'}
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              {/* Use supplier_id */}
              <Select onValueChange={(value) => handleSelectChange('supplier_id', value)} value={formState.supplier_id}>
